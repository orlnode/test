...
Je redonne ici les maths : 
   Données :  une pool de liquidité entre deux actifs A et B, on notera L_A et L_B 
   les liquidités. 
   ...
   On introduit la matrice : 
    ...
    et on a parlais de la matrice de fee 
...
(si y'a des gens qui passe une transaction en même temps que nous ca va changer 
legérement les valeurs). 
...
mais la fonction blockchain.execute() ne prend pas ça en charge (y'a un calcul automatique des 
frais qui est fait par cette fonction, donc toujours avoir des tokens des blockchains utilisée)
...
i. gaiaid tx ibc-transfer transfer transfer channel-141 
...
def swap_test():
    ...
    les liquidité (L_A = 995085334)  que
    ...
    que la composition de fonction pour sage 
    ...
    [2142127795898656                0]
    [             997     995085534000]
    prediction : 215270 uumee pour 100 uatom  <---
    gas estimate: 369607
    -100
    215270 < --- perfecto
